...
class ModelEvaluation:
    ...
    def run_evaluation(self):
        print(f"[ModelEvaluation] Ingesting engineered dataset for evaluation: {self.engineered_file}")
        ...
        print(f"[ModelEvaluation] Data Splits: Val={len(df_val)}, Test={len(df_test)}")
        ...
        print("[ModelEvaluation] Reloading Random Forest models...")
        ...
        print("[ModelEvaluation] Reloading XGBoost models...")
        ...
        print("[ModelEvaluation] Reloading Deep GRU model...")
        ...
        print("[ModelEvaluation] Auditing RF forecasts via Z3 Guardrail...")
        ...
        print(f"[ModelEvaluation] ✅ Metrics exported to {self.metrics_file}")
        ...
        print(f"[ModelEvaluation] ✅ Reliability diagram saved locally and synced to S3.")
        ...
        print(f"[ModelEvaluation] ✅ ROC-AUC curves saved locally and synced to S3.")
        ...
        print("[ModelEvaluation] ✅ End-to-end evaluation complete!")
